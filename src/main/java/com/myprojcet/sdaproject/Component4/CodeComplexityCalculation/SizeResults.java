...
import com.myprojcet.sdaproject.Component4.CodeComplexityCalculation.Reports.SizeReport.SizeReport;
 ...
 */
public class SizeResults extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SizeResults
     */
    public SizeResults() {
        initComponents();
    }

    public SizeResults(List codeLines, List lineByLineSize) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Size Complexity Calculation");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        SizeReport newSizeReport = new SizeReport(this.codeLines, this.lineByLineSize);
        newSizeReport.generateReport();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SizeResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SizeResults().setVisible(true);
            }
        });
    }
