...
//This class contains some of the methods that are used commonly by other classes.
public class Utility {
    ...
    public List<String> getObjects(List<String> identifiedKeywords) {
        
        List<String> classesAndObjects = new ArrayList();
