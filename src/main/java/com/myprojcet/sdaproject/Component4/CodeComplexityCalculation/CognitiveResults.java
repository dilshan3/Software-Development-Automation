...
import com.myprojcet.sdaproject.Component4.CodeComplexityCalculation.Reports.CognitiveReport.CognitiveReport;
 ...
 */
public class CognitiveResults extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CognitiveResults
     */
    public CognitiveResults(){
        initComponents();
    }
    
    public CognitiveResults(List codeLines, List lineByLineSize, List methodPositions, List lineByLineRecursion) {
        initComponents();
    ...
    public void generateResults(){
        ...
        for(int i = 0; i < this.lineByLineSize.size(); i++){
            ...
            System.out.println(this.lineByLineSize.get(i) + " | " + this.lineByLineRecursion.get(i));
        }
        ...
        for(int i = 0; i < this.codeLines.size(); i++) {
            ...
            o[1] = this.calculatedComplexityLinebyLine.get(i);
            dataModel.addRow(o);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cognitive Complexity Calculation");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CognitiveReport newCognitiveReport = new CognitiveReport(this.codeLines, this.lineByLineSize, this.methodPositions, this.lineByLineRecursion);
        newCognitiveReport.generateReport();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CognitiveResults.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CognitiveResults().setVisible(true);
            }
        });
    }
